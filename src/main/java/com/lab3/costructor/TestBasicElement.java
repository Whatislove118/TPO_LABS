...
public class TestBasicElement {
    ...
    @Test
    public void testBasicElement() throws InterruptedException {
        Actions actions = new Actions(chromeDriver);
        actions.dragAndDrop(constructorpage.getBasicElement(), constructorpage.getCanvas());
        Thread.sleep(1000);
        Assert.assertTrue(constructorpage.getCanvas().findElement(By.xpath("//*[@id=\"ul-panelConstructor\"]/div[2]/div/div[1]/div[1]/div[1]/div[1]/div[1]/ul/li[6]")).isEnabled());
