...
public class TestMediaElement {
    ...
    @Test
    public void testMediaElement() throws InterruptedException {
        Actions actions = new Actions(chromeDriver);
        actions.dragAndDrop(constructorpage.getMediaElement(), constructorpage.getCanvas());
        Thread.sleep(1000);
        Assert.assertTrue(constructorpage.getCanvas().findElement(By.xpath("//*[@id=\"ul-panelConstructor\"]/div[2]/div/div[1]/div[1]/div[1]/div[1]/div[6]/ul/li[1]")).isEnabled());
