...
public class TestSocialElement {
    ...
    public void testSocialElement() throws InterruptedException {
        ...
        actions.dragAndDrop(constructorpage.getSocialElement(), constructorpage.getCanvas());
        Thread.sleep(1000);
        Assert.assertTrue(constructorpage.getCanvas().findElement(By.xpath("//*[@id=\"ul-panelConstructor\"]/div[2]/div/div[1]/div[1]/div[1]/div[1]/div[8]/ul/li[3]")).isEnabled());
