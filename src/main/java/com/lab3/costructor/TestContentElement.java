...
public class TestContentElement {
    ...
    @Test
    public void testContentElement() throws InterruptedException {
        Actions actions = new Actions(chromeDriver);
        actions.dragAndDrop(constructorpage.getContentElement(), constructorpage.getCanvas());
        Thread.sleep(1000);
        Assert.assertTrue(constructorpage.getCanvas().findElement(By.xpath("//*[@id=\"ul-panelConstructor\"]/div[2]/div/div[1]/div[1]/div[1]/div[1]/div[3]/ul/li[12]")).isEnabled());
