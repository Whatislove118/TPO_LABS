...
public class TestContactsElement {
    ...
    @Test
    public void testContactsElement() throws InterruptedException {
        Actions actions = new Actions(chromeDriver);
        actions.dragAndDrop(constructorpage.getContactsElement(), constructorpage.getCanvas());
        Thread.sleep(1000);
        Assert.assertTrue(constructorpage.getCanvas().findElement(By.xpath("//*[@id=\"ul-panelConstructor\"]/div[2]/div/div[1]/div[1]/div[1]/div[1]/div[7]/ul/li[1]")).isEnabled());
